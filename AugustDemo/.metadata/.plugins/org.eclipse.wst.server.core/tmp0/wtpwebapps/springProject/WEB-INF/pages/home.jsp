                  ...
                  for(i=0; i<lngth;i++){
                	  ...
                	  if(idSplit.length == 2){
                		 ...
                		 var val1 = values[1].split(':');
                		  $('#inner-rightTree').append('<ul id="ul_'+countout+'"> <button type="button" id="cul_'+countout+'" class="minus btn btn-info" data-toggle="collapse" data-target=".ul_'+countout+'">-</button><button type="button" id="eul_'+countout+'" class="btn btn-info plus" data-toggle="collapse" data-target=".ul_'+countout+'">+</button><span class="QA">Question : </span><span class="tab">'+val1[1]+'</span></ul>');
                	  }
                	  else{
                		  ...
                		  if(x == 1){
                			 ...
                			 countout++;
                			  var val1 = values[1].split(':');
                			$("#ul_"+ct).append('<ul class="ul_'+ct+'" id="ul_'+countout+'"><button type="button" id="cul_'+countout+'" class="btn btn-info minus" data-toggle="collapse" data-target=".ul_'+countout+'">-</button><button type="button" id="eul_'+countout+'" class="btn btn-info plus" data-toggle="collapse" data-target=".ul_'+countout+'">+</button><span class="QA">Question : </span><span class="tab">'+val1[1]+'</span></ul>');
                			
                		  }
                		  else{
                		  var val1 = values[1].split(':');
                		  $("#ul_"+countout).append('<li class="ul_'+countout+'"><span class="ans">Answer : </span><span class="tab">'+val1[1]+'</span></li>');
                	  ...
                	  $('.btn').click(function(){
             			var bId = $(this).attr('id');
                		var typ = bId.charAt(0);
                		if(typ == 'c'){
                			$('#'+bId).hide();
                			var newId = bId.replace('c','e');
                			$('#'+newId).show();
                		}
                		
                		if(typ == 'e'){
                			$('#'+bId).hide();
                			var newId = bId.replace('e','c');
                			$('#'+newId).show();
                		}
             		  });
                  }
